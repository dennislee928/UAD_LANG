...
| 語言 | LOC | 核心概念映射 | 結構複雜度 | 時間結構化支持 |
|------|-----|-------------|-----------|---------------|
| **UAD** | ~350 | 5/5 | 低 | 原生支持 |
| **Go** | ~600+ | 3/5 | 中 | 需要自定義實現 |
...
| 場景 | 語言 | LOC | 概念映射 | 複雜度 | 領域適配度 |
|------|------|-----|---------|--------|-----------|
| Ransomware Kill-chain | **UAD** | ~350 | 5/5 | 低 | ⭐⭐⭐⭐⭐ |
| | Go | ~600+ | 3/5 | 中 | ⭐⭐⭐ |
| SOC ERH Model | **UAD** | ~200 | 5/5 | 低 | ⭐⭐⭐⭐⭐ |
| | Go | ~400+ | 2/5 | 高 | ⭐⭐ |
| Psychohistory | **UAD** | ~250 | 5/5 | 低 | ⭐⭐⭐⭐⭐ |
| | Python | ~500+ | 3/5 | 中 | ⭐⭐⭐ |

### 關鍵發現

1. **代碼量減少**: UAD 平均減少 40-50% 的代碼量
...
- [ ] Go 實現：ransomware_killchain.go
- [ ] Go 實現：soc_erh_model.go
- [ ] Python 實現：psychohistory_scenario.py
- [ ] Rust 實現（可選）：對比性能
